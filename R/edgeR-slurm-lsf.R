...
#'
#' @export
slurmEdgeR <- function(dgeList, designContrast,
                       outdir="edgeR_output",
                       outfilePrefix="an-unnamed-project-",
...
lsfEdgeRcommand <- function(dgeList, 
  ...
  bsub <- c("#!/bin/bash",
            ...
            "#BSUB -M 2GB ## 2 GB memory per CPU",
