...
#' @importFrom ribiosExpression groups dispGroups designMatrix contrastMatrix contrastNames nContrast contrastSampleIndices truncateDgeTable annotate
...
#' @exportClasses RiboSeq riboSeqAnalysisObject EdgeResult EdgeObject EdgeGSE DGEList2
#' @exportMethods setRnks RiboSeq normalize countRNA countRPF cpmRNA cpmRPF cpmRNAGroupSum cpmRPFGroupSum cpmFilter featureNames sampleNames commonDisp commonDisp<- BCV show plotBCV dgeList normFactors EdgeObject isAnnotated designMatrix<- contrastMatrix<-
NULL
