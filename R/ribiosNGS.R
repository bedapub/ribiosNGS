...
#' @exportClass RiboSeq riboSeqAnalysisObject EdgeResult EdgeObject EdgeGSE DGEListList
#' @exportMethod setRnks RiboSeq normalize countRNA countRPF cpmRNA cpmRPF cpmRNAGroupSum cpmRPFGroupSum cpmFilter featureNames sampleNames commonDisp commonDisp<- BCV plotBCV dgeList normFactors EdgeObject isAnnotated designMatrix<- contrastMatrix<-
