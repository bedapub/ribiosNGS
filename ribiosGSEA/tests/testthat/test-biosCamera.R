...
## TODO: limma::camera has been updated

gs <- list(GeneSet1=index1, GeneSet2=index2)
(cameraRes <- camera(y, gs, design, inter.gene.cor=NA, allow.neg.cor=FALSE))
...
## test rankSum test
(cameraRsRes <- camera(y, gs, design, use.ranks=TRUE, inter.gene.cor=NA, allow.neg.cor=FALSE))
