...
Cppout1 <- davidClustering_kappa(synKappaMat.round2, kappaThr=0.35)
Cppout2 <- davidClustering_kappa(synKappaMatTp.round2, kappaThr=0.35)
...
system.time(cppres <- davidClustering_kappa(largematKappa))
