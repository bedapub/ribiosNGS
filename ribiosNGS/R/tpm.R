...
#' @param x A count matrix or other objects that can be converted to a matrix by \code{as.matrix}
#' @param gene.length A numeric vector of the same length as the row count of \code{x}, giving gene lengths
#' 
