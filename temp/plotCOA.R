...
plotCOA <- function(ord, classvec=NULL, arraycol=NULL, xlim=NULL, ylim=NULL,...) {
  ord.co <- ord$ord$co
  ...
  plotarrays(ord.co, classvec=classvec,arraycol=arraycol, grid=FALSE, add.plot=TRUE, cpoint=1.5, labelsize=0.8)
}
