...
expect_identical(ribiosNGS:::shortStr("ETV"), "ETV")
expect_identical(ribiosNGS:::shortStr("abcdefgh"), "abcdefgh")
expect_identical(ribiosNGS:::shortStr("abcdefghijkl"), "abcdefgh...")

expect_identical(ribiosNGS:::fixWidthShortStr("ETV"), "ETV     ")
expect_identical(ribiosNGS:::fixWidthShortStr("abcdefgh"), "abcdefgh")
expect_identical(ribiosNGS:::fixWidthShortStr("abcdefghijkl"),
                 "abcde...")
